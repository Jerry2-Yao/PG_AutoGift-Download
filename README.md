...
> 本說明對應版本:**v0.5**——新增「自動點擊時顯示紅點」(每次點擊都能看到點在哪);每輪上限預設值改成 100。「全部做完」的修法仍待實機驗證,詳見「已知限制」
...
👉 **[點我下載 PG_AutoGift-v0.5.apk](https://github.com/Jerry2-Yao/PG_AutoGift-Download/releases/download/v0.5/PG_AutoGift-v0.5.apk)**
...
### 第一步:看點擊時閃的紅點,或事後看存檔截圖,判斷是哪一種問題

**每次自動點擊,畫面上都會在點下去的實際位置閃一下紅點**(v0.5 新增,設定裡預設開啟,不想要可以關掉)。跑起來的時候盯著手機看:
